                        ...
                        <tbody>
                            @foreach ($perusahaan as $key => $item)
                                <tr class="text-center">
                                    ...
                                    <td>{{ $item->alamat }}</td>
                                    <td>
                                        <a href="/perusahaan/edit/{{ $item->nis }}" class="btn btn-success">
                                        ...
                                        <a href="/perusahaaan/delete/{{ $item->nis }}" onclick="return window.confirm('hapus data ini?')" class="btn btn-danger">
