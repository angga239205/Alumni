        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>SI BKK</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="alumni"><i class="fa fa-alumni"></i>alumni</span></a>
                  </li>
                  <li><a href="perusahaan"><i class="fa fa-Perusahaan"></i>perusahaan</span></a>
                  </li>
                  <li><a href="lowongan"><i class="fa fa-Lowongan"></i>lowongan</span></a>
                  </li>
                  <li><a href="lamaran"><i class="fa fa-lamaran"></i>lamaran</span></a>
